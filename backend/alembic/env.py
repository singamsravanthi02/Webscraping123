...
from app.domain.users.models import User # import all models here to register metadata
from app.domain.jobs.models import Job, JobBookmark
from app.domain.job_discovery.models import (
